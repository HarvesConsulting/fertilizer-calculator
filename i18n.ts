...
const translations = {
  en: {
    ...
    nitrogenAnalysisLabel: "Nitrate Nitrogen (N)",
    ...
    saveXlsxAction: "Save as XLSX",
    saveJsonAction: "Save as Project (JSON)",
    ...
    springFertilizerRateTooltip: "The rate is automatically calculated to cover {percent}% of the potassium (K₂O) need at the initial growth stages, which is key for root system development and overall plant resilience. You can adjust this value manually.",
    kCompensationLabel: "K₂O Comp.",
    kCompensationTooltip: "Specify the percentage of total Potassium (K₂O) requirement that should be applied with the complex starter fertilizer.",
  ...
  uk: {
    ...
    nitrogenAnalysisLabel: "Нітратний азот (N)",
    ...
    saveXlsxAction: "Зберегти в XLSX",
    saveJsonAction: "Зберегти як проект (JSON)",
    ...
    springFertilizerRateTooltip: "Норма розраховується автоматично для покриття {percent}% потреби в калії (K₂O) на початкових етапах росту, що є ключовим для розвитку кореневої системи та загальної стійкості рослини. Ви можете відкоригувати це значення вручну.",
    kCompensationLabel: "Комп. K₂O",
    kCompensationTooltip: "Вкажіть відсоток від загальної потреби в калії (K₂O), який має бути внесений зі стартовим комплексним добривом.",
    ...
    reportLoadError: "Не вдалося завантажити звіт. Файл пошкодено або має неправильний формат.",
  ...
  es: {
    ...
    nitrogenAnalysisLabel: "Nitrógeno Nítrico (N)",
    ...
    saveXlsxAction: "Guardar como XLSX",
    saveJsonAction: "Guardar como Proyecto (JSON)",
    ...
    springFertilizerRateTooltip: "La dosis se calcula automáticamente para cubrir el {percent}% de la necesidad de potasio (K₂O) en las etapas iniciales de crecimiento, lo cual es clave para el desarrollo del sistema radicular y la resiliencia general de la planta. Puede ajustar este valor manualmente.",
    kCompensationLabel: "Comp. K₂O",
    kCompensationTooltip: "Especifique el porcentaje del requerimiento total de Potasio (K₂O) que debe aplicarse con el fertilizante de arranque complejo.",
